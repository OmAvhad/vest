...
import { Wallet, User, Mail, Building, ChevronRight, CircleDollarSign } from 'lucide-react';
      ...
      <div className="grid gap-6">
        ...
        <Card className="relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h2 className="text-3xl font-bold mb-4">₹{user?.balance?.toFixed(2)}</h2>
        ...
        <Card>
          <div className="flex items-center mb-6">
            ...
            <div className="ml-4">
              ...
              <p className="text-gray-500 text-sm">{user?.user_type} Account</p>
            </div>
          </div>
